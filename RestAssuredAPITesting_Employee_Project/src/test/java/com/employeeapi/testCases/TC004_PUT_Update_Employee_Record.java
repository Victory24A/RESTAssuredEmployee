...
public class TC004_PUT_Update_Employee_Record extends TestBase {
	...
	void createEmployee() throws InterruptedException
	{
		...
		Response	response	=	httpRequest.request(Method.PUT,"/update/"+empID);	//22
	...
	void tearDown()
	{
		logger.info("******************* Finished TC004_PUT_Update_Employee_Record *******************");
	}
